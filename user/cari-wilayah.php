      ...
      <div class="row">
        ...
        <main class="main-content col-lg-10 col-md-9 col-sm-12 p-0 offset-lg-2 offset-md-3">
          ...
          <div class="main-content-container container-fluid px-4"> 
            ...
            <div class="container header-peta-lokasi">Peta Lokasi</div>
            ...
            ?>
              <form action="cari-wilayah.php?act=faskes" method="post">
                ...
                <select name="kota">
                  ...
                  <option value="Kab Bogor">KABUPATEN BOGOR</option>    
                </select>
            ...
            <div class="container box-peta-lokasi">
              ...
              <div class="container line-info-lokasi">
                ...
                <i class="fa fa-hand-point-right"></i>&nbsp;&nbsp;Aplicares menampilkan data profil fasilitas kesehatan yang bekerja sama dengan BPJS Kesehatan.<br>
